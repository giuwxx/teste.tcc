...
<head>
    ...
    <link rel="stylesheet" href="src/css/inex.css">
    ...
    <header class="header">
        <nav class="nav-container">
            <div class="logo-container">
                <img src="src/img/logo-azul.png" alt="Intelecta Logo" class="logo">
    ...
    <section class="hero">
        <div class="hero-content">
            ...
            <div class="hero-visual">
                <img src="src/img/desenho.png" alt="">
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="footer-content">
                <div class="footer-brand">
                    <div class="logo-container">
                        <img src="src/img/logo.png" alt="Intelecta Logo" class="logo">
                        <span class="brand-name">Intelecta</span>
                    </div>
                ...
                <div class="footer-links">
                    ...
                    <div class="footer-column">
                        ...
                        <ul>
                            ...
                            <li><a href="#">Material Complementar</a></li>
                        </ul>
                    </div> 
                    <div class="footer-column">
                        <h4>Suporte</h4>
